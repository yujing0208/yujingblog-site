	...
	window.EditorSchemas = {
		...
		diary: {
			...
			fields: [
				...
				{ key: "imgMode", label: "图片模式", type: "select", options: [
				{ label: "默认（九宫格）", value: "" },
				{ label: "填充", value: "mode-fill" },
				{ label: "小图网格", value: "mode-grid" },
				{ label: "中等尺寸", value: "mode-mid" },
				{ label: "正方形填充", value: "mode-squarefill" },
				{ label: "大图双列", value: "mode-large2" },
			], optional: true },
				{ key: "id", label: "ID", type: "number", hidden: true },
			],
		},
		...
		post: {
			...
			fields: [
				...
				{ key: "date", label: "写作日期", type: "date", optional: true, placeholder: "留空则与 published 一致" },
				...
				{ key: "category", label: "分类", type: "select", options: ["技术教程", "博客折腾", "技术项目", "技术随笔", "推荐分享", "生活随笔", "计划", ""], creatable: true },
		...
		albums: {
			...
			fields: [
				...
				{ key: "tags", label: "标签", type: "tags" },
				{ key: "encrypted", label: "启用加密", type: "boolean", optional: true },
