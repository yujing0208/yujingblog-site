...
export const projectsData: Project[] = [
	{
		id: "mizuki",
		title: "Mizuki",
		description: "一个现代化、功能丰富的静态博客模板，采用 Astro 构建，具备高级功能和精美设计。",
	...
	},
	{
		...
		description: "关于iFlytek C8hPro平板刷机操作的一些研究很多地方尚有不足之处,在此抛砖引玉,欢迎各位读者开issues与我讨论。",
	...
	},
	{
		id: "ClassIsland",
		title: "ClassIsland",
		description: "ClassIsland 是一款适用于班级多媒体屏幕的跨平台课表信息显示工具，可以在 Windows PC、Mac 及 Linux 设备屏幕上显示各种信息。本应用的名字灵感源于 iOS 灵动岛(Dynamic Island)功能。",
	...
	},
	{
		...
		description: "开源文件托管解决方案,安心存取，轻松分享",
		image: "",
		category: "web",
		techStack: [
			"Vue 3",
		...
		visitUrl: "https://img.yujingblog.top/",
	...
	},
	{
		id: "YuJingの宝藏之地",
		title: "YuJingの宝藏之地",
		description: "这是一个采用 Next.js 构建的高颜值、毛玻璃(Glassmorphism)风格个人博客系统。本项目自带完善的前端展示与独立的本地后台控制台，支持 Markdown 沉浸式写作、草稿管理以及便捷的图床配置。",
	...
	},
	{
		id: "Mineradio",
		title: "Mineradio",
		description: "Mineradio 是一款 Windows 桌面沉浸式音乐播放器，把搜索播放、歌词舞台、粒子视觉、3D 歌单架和完整桌面模式组合成一个更接近现场感的私人音乐空间。",
		...
		status: "completed",
		sourceCode: "https://github.com/XxHuberrr/Mineradio",
		visitUrl: "https://mineradio.cn/",
	...
	},
	{
		id: "NoteWeb - 便签墙",
		title: "NoteWeb - 便签墙",
		description: "一个简洁美观的在线便签墙网页，支持添加、查看、拖动和管理便签。",
		image: "https://img.yujingblog.top/file/1785781799608_image.webp",
		category: "web",
		techStack: [
			"HTML5",
			"SQLite"
		...
		status: "completed",
		sourceCode: "https://github.com/ZyPLJ/NoteWeb",
		visitUrl: "https://notes.yujingblog.top/",
		startDate: "2026-08-03",
		endDate: "2026-08-03",
		featured: false,
		tags: [
