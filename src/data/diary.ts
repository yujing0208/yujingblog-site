...
const diaryData: DiaryItem[] = [
	...
	{
		content:
			"记录，第一次被攻击，虽然只是储存xxs，我只限输入30字，想着应该拿不到我的Cookie就没事。就今天输密码半天进不去，我还真以为拿到了，一检查才发现是之前误删worker，变量跟着丢了，忘加了😒\n但因为textContent 是空的或和原文不一致，管理员还删不掉，也确实被折腾了😅",
		date: "2026-08-11T15:41:00+08:00",
		images: ["https://img.yujingblog.top/file/1786432856824_image.png"],
		location: "",
		mood: "震惊",
		tags: ["技术"],
		imgMode: "mode-fill",
	...
	},
	{
		...
		images: ["https://img.yujingblog.top/file/1786107895461_image.webp"],
		location: "电脑前",
		mood: "崩溃",
		tags: ["博客更新"],
		imgMode: "mode-grid",
	...
	},
	{
		id: 8,
		content:
			"买了个lived2d模型，0.15￥呢。原本准备放到博客里，但这个好像是转卖的，算了我支持正版(咳咳！绝对不是因为不会去水印 嗷┗|｀O′|┛~~)",
	...
	},
	{
		id: 4,
		content:
			"删了小两百个好友，十来天了，还是只有四个人发现，轮存在感这一块👍。",
	...
	},
	{
		id: 3,
		content:
			"我的token呀!/(ㄒoㄒ)/~~,这复刻个GitHub上的开源项目这么烧token,用了ClawX和CodeX,这个CodeX现在怎么放在Chat GTP里了，没有想象的好用（呃有可能是因为换了模型吧）总之白期待了，我的token啊，早知道不偷懒了，呜呜呜😒",
	...
	},
	{
		id: 1,
		content:
			"它老冯的！这个博客写了好几天了。今天终于写到日记了，算鸟，当学MarkDown了。",
	...
	{
		content:
			"今天早晨才下定决心重新建站，上个版本同步源码有问题。看来我赌对了，这个版本同步很成功！准备接下来把评论系统，AI，图床搞好。",
	...
	{
		content:
			"不对呀，这个gemini api key怎么要满18啊，那我不是白注册谷歌账号了吗😓",
